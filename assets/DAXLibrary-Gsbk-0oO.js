...
RETURN
DIVIDE(CumulativeSales, TotalSales)`,category:"Advanced Analytics"}],L=()=>{const{addToast:a}=T(),[t,i]=n.useState(""),[o,r]=n.useState(null),[d,g]=n.useState(!0);n.useEffect(()=>{const s=setTimeout(()=>g(!1),300);return()=>clearTimeout(s)},[]);const u=j.filter(s=>{const l=t.toLowerCase();return s.title.toLowerCase().includes(l)||s.description.toLowerCase().includes(l)||s.category.toLowerCase().includes(l)}),A=(s,l)=>{navigator.clipboard.writeText(s),r(l),a("DAX pattern copied to clipboard!","success"),setTimeout(()=>r(null),2e3)};return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-2xl font-bold text-slate-900",children:"DAX Pattern Library"}),e.jsx("p",{className:"text-slate-600",children:"HHS & WebFirst approved metrics and patterns."})]}),e.jsxs("div",{className:"flex gap-2 sm:gap-3 w-full md:w-auto",children:[e.jsxs("div",{className:"relative flex-1 md:w-64",children:[e.jsx(N,{className:"absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 h-4 w-4"}),e.jsx("input",{type:"text",placeholder:"Search patterns...",className:"input-field pl-10 text-sm",value:t,onChange:s=>i(s.target.value)})]}),e.jsxs("button",{onClick:()=>a("Request submitted to Analytics Lead.","info"),className:"btn-secondary whitespace-nowrap flex-shrink-0 text-xs sm:text-sm",title:"Request a new DAX pattern",children:[e.jsx(h,{className:"h-4 w-4 sm:mr-2"}),e.jsx("span",{className:"hidden xs:inline",children:"Request"}),e.jsx("span",{className:"hidden sm:inline",children:"Pattern"})]})]})]}),d?e.jsx(w,{items:6,className:"grid grid-cols-1 gap-6"}):u.length>0?e.jsx("div",{className:"grid grid-cols-1 gap-6",children:u.map(s=>e.jsxs(x.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},className:"card group",children:[e.jsxs("div",{className:"flex justify-between items-start mb-4",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-3 mb-1",children:[e.jsx("h3",{className:"text-lg font-semibold text-brand-700",children:m(s.title,t)}),e.jsx("span",{className:"text-xs px-2 py-1 rounded-full bg-slate-100 text-slate-600 border border-slate-200",children:m(s.category,t)})]}),e.jsx("p",{className:"text-sm text-slate-600",children:m(s.description,t)})]}),e.jsx("button",{onClick:()=>A(s.code,s.id),className:"p-2 rounded-lg bg-slate-100 hover:bg-brand-600 text-slate-500 hover:text-white transition-colors duration-200",title:"Copy DAX",children:o===s.id?e.jsx(C,{className:"h-5 w-5"}):e.jsx(y,{className:"h-5 w-5"})})]}),e.jsx("div",{className:"relative",children:e.jsx("pre",{className:"bg-slate-50 p-4 rounded-lg overflow-x-auto text-sm font-mono text-slate-700 border border-slate-200",children:e.jsx("code",{children:s.code})})})]},s.id))}):e.jsxs("div",{className:"text-center py-12 text-slate-400",children:[e.jsx(h,{className:"h-12 w-12 mx-auto mb-3 opacity-20"}),e.jsxs("p",{children:["No patterns found for “",t,"”"]}),e.jsx("button",{onClick:()=>i(""),className:"text-brand-600 font-medium hover:underline mt-2",children:"Clear search"})]})]})};export{L as default};
